  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 py-12 text-center">
      ...
      <div className="bg-white p-12 rounded-[3rem] border-2 border-slate-100 shadow-xl">
        ...
        <h2 className="text-3xl font-black text-slate-900 mb-4">Block 4: Fake KYC & Aadhaar Cloning</h2>
        <p className="text-slate-600 text-lg mb-8">This simulation is coming soon! You will learn how to spot fake government websites and protect your biometric data.</p>
